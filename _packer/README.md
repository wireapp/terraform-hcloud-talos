...
> talos_version = "v1.13.9" # Replace with your desired Talos version
>
...
3.  **Get Custom Image URLs:**
    ...
    Replace `<SCHEMATIC_ID>` with the ID obtained in the previous step and `<TALOS_VERSION>` with the target Talos version (e.g., `v1.13.9`).
